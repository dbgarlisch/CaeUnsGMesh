...
#             All rights reserved.
#
# modulelocal.mk for src\plugins\CaeUnsGMesh plugin
########################################################################
...
# The file paths are relative to the project path macro CaeUnsGMesh_LOC.
# For example,
#    myFile.cxx is located in $(CaeUnsGMesh_LOC)/myFile.cxx
#    sub/myOtherFile.cxx is located in $(CaeUnsGMesh_LOC)/sub/myOtherFile.cxx
#
#CaeUnsGMesh_CXXFILES_PRIVATE := \
#    yourfile1.cxx \
#    yourfile2.cxx \
#	$(NULL)
...
#
#CaeUnsGMesh_MAINT_TARGETS_PRIVATE = \
#	$(NULL)
...
#
#CaeUnsGMesh_sample: CaeUnsGMesh_clean CaeUnsGMesh
#	@echo "done building CaeUnsGMesh"
