 ...
 * To make plugin specific changes, you should edit CaeUnsGMesh.cxx
...
{
    CaeUnsGMesh plugin(pRti, model, pWriteInfo);
    return plugin.run();
}
...
{
    return CaeUnsGMesh::create(*pRti);
}

PWP_VOID
runtimeDestroy(CAEP_RTITEM *pRti)
{
    return CaeUnsGMesh::destroy(*pRti);
}
