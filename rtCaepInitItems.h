...
*/
#define ID_CaeUnsGMesh  1199
{
    /*== CAEP_FORMATINFO FormatInfo */
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "Gmsh",             /* const char *name */
        MAKEGUID(ID_CaeUnsGMesh),  /* PWP_UINT32 id */
    ...
    CaeUnsGMeshBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(CaeUnsGMeshBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    CaeUnsGMeshVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(CaeUnsGMeshVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsGMeshFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsGMeshFileExt), /* PWP_UINT32 ExtCnt */
